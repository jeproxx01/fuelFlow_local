      ...
      >
        ...
        <div className="p-6 mt-16">
          <header className="flex justify-between items-center bg-white p-4 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold">Accounts - (Customer)</h2>
          </header>
            ...
            <table className="w-full mt-4 border-collapse border border-gray-200">
              ...
              <tbody>
                {[...Array(10)].map((_, index) => (
                  ...
                  >
                    <td className="p-2">Louie Gerson Galolo</td>
                    <td className="p-2">lowe@gmail.com</td>
                    <td className="p-2">09634883710</td>
                  </tr>
                ))}
              </tbody>
            </table>
