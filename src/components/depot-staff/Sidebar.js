        ...
        <ul className="space-y-4">
          ...
          <li
            className={`mx-2 rounded-md ${
              pathname === "/depot-staff/dashboard"
                ? "bg-gray-500"
                : "hover:bg-blue-800"
            }`}
          >
            <a
              href="/depot-staff/dashboard"
          ...
          <li
            className={`mx-2 rounded-md ${
              pathname === "/depot-staff/fuel"
                ? "bg-gray-500"
                : "hover:bg-blue-800"
            }`}
          >
            <a
              href="/depot-staff/fuel"
              className="flex items-center p-3 space-x-2"
            >
              <span>⛽</span>
          ...
          <li
            className={`mx-2 rounded-md ${
              pathname === "/depot-staff/truck"
                ? "bg-gray-500"
                : "hover:bg-blue-800"
            }`}
          >
            <a
              href="/depot-staff/truck"
              className="flex items-center p-3 space-x-2"
            >
              <span>🚚</span>
          ...
          <li
            className={`mx-2 rounded-md ${
              pathname === "/depot-staff/order"
                ? "bg-gray-500"
                : "hover:bg-blue-800"
            }`}
          >
            <a
              href="/depot-staff/order"
              className="flex items-center p-3 space-x-2"
            >
              <span>📦</span>
